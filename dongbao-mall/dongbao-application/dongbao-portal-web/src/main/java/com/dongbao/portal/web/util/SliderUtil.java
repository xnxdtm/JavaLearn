...
public class SliderUtil {
	...
	public static VerificationVO  cut(){
		// 读取图库目录
		File imgCatalog = new File("/Users/xuanzhimen/Desktop/MCA/myCode/dongbao/dongbao-file/captchaImage");
		...
		if (CollectionUtil.isNotEmpty(files)) {
			...
			// 随机选择剪切模版
			File tempImgFile = new File("/Users/xuanzhimen/Desktop/MCA/myCode/dongbao/dongbao-file/captchaImage/cut" + (new Random().nextInt(6) + 1) + "-w.png");
			try {
